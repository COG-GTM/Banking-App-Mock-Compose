...
fun ConfirmTopUpDialog(
    ...
    Dialog(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.confirm_top_up_title), style = TextStyle(
                    fontSize = 24.sp,
            ...
            Text(
                text = stringResource(R.string.confirm_top_up_message, amount), style = TextStyle(
                    fontSize = 14.sp,
                    lineHeight = 24.sp,
                    fontFamily = primaryFontFamily,
...
@Composable
@Preview
fun ConfirmTopUpDialog_Preview() {
    BankingAppTheme {
        ScreenPreview {
            ConfirmTopUpDialog(amount = "$100")
        }
    }
}
