...
private fun EditProfileScreen_Ui(
    ...
    onIntent: (EditProfileScreenIntent) -> Unit = {},
    onBack: () -> Unit = {},
) {
    ...
    Column(
        ...
        SecondaryToolBar(
            onBack = onBack,
            title = UiText.StringResource(R.string.change_personal_profile),
        )
        ...
        Column(
            ...
            DecoratedFormField(
                ...
                onValueChange = { onIntent(EditProfileScreenIntent.FirstNameChanged(it)) },
            )
            ...
            DecoratedFormField(
                ...
                onValueChange = { onIntent(EditProfileScreenIntent.LastNameChanged(it)) },
            )
            ...
            DecoratedFormField(
                ...
                onValueChange = { onIntent(EditProfileScreenIntent.NickNameChanged(it)) },
            )
            ...
            DecoratedFormField(
                ...
                uiField = state.email,
                onValueChange = { onIntent(EditProfileScreenIntent.EmailChanged(it)) },
            )

            Spacer(modifier = Modifier.height(32.dp))

            PrimaryButton(
                onClick = { onIntent(EditProfileScreenIntent.SaveProfile) },
                modifier = Modifier.fillMaxWidth(),
